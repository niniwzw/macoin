...
{
    return GetBoolArg("-testnet", false) ? 21888 : 11888;
}
...
{ //  name                      function                 safemd  unlocked
  //  ------------------------  -----------------------  ------  --------
	...
	{ "sendtobackaddress",      &sendtobackaddress,          false,  false },
	{ "sendtoaddress2",          &sendtoaddress2,          false,  false },
	{ "createbacktransaction",          &createbacktransaction,          false,  false },
	...
	{ "addbackaddress",         &addbackaddress,         false,  false },
	...
	{ "createrawtransaction2",  &createrawtransaction2,  false,  false },
...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
	...
	if (strMethod == "sendtobackaddress"          && n > 1) ConvertTo<double>(params[1]);
	...
	if (strMethod == "createbacktransaction"  && n > 2) ConvertTo<double>(params[2]);
    ...
    if (strMethod == "addbackaddress"     && n > 0) ConvertTo<int64_t>(params[0]);
    if (strMethod == "addbackaddress"     && n > 1) ConvertTo<Array>(params[1]);
    if (strMethod == "addbackaddress"     && n > 2) ConvertTo<Array>(params[2]);
    if (strMethod == "addbackaddress"     && n > 3) ConvertTo<Array>(params[3]);
    if (strMethod == "addbackaddress"     && n > 4) ConvertTo<Array>(params[4]);
    ...
    if (strMethod == "signrawtransaction2"     && n > 1) ConvertTo<Array>(params[1], true);
    if (strMethod == "signrawtransaction2"     && n > 2) ConvertTo<Array>(params[2], true);
