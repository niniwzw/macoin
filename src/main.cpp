...
const string strMessageMagic = "bityuan Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bityuan", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nNonce   = !fTestNet ? 3529589 : 216178;
        ...
        //// debug print
        block.print();
        assert(block.hashMerkleRoot == uint256("0xa65655a487894e4dd177a7d7ec63b61416bc50afb5c350810476c1f6af6b1919"));
...
unsigned char pchMessageStart[4] = {0x20, 0x14, 0x09, 0x10 };
