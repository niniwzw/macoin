...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "2014/08/15 Macoin New Wallet Come back.";
        CTransaction txNew;
        txNew.nTime = 1407974636;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
unsigned char pchMessageStart[4] = { 0x20, 0x08, 0x06, 0x19 };
