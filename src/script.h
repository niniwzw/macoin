...
bool ExtractDestinations2(const CScript& scriptPubKey, txnouttype& typeRet, std::vector<CTxDestination>& addressRet, std::vector<CTxDestination>& addressBack, int& nRequiredRet, std::vector<int>& vMinTime);
