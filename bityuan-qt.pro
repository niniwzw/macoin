...
TARGET = bityuan-qt
VERSION = 1.2.1.2
INCLUDEPATH +=  /usr/local/include src src/json src/qt
...
LIBS += -L/usr/local/lib -L/opt/local/lib $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,)
